...
class CouponForm extends FormBase
{
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    // Data to JS
    $form['#attached']['drupalSettings']['coupon']['numberOptions'] =
      $this->number_options;
    $form['#attached']['drupalSettings']['coupon']['amountOptions'] =
      $this->amount_options;
    $form['#attached']['drupalSettings']['coupon']['couponSingular'] =
      $this->coupon_singular;
    $form['#attached']['drupalSettings']['coupon']['couponPlural'] =
      $this->coupon_plural;
    ...
    $form['coupon']['table']['header'] = [
      '#theme' => '',
      '#prefix' =>
        '<div id="coupon-table-header" class="coupon-table-header">
                <span class="coupon-table-number">' .
        $this->text_number .
        '</span>
    ...
    for ($i = 1; $i <= 10; $i++) {
      ...
      $form['coupon']['table']['row_' . $i]['amount-' . $i] = [
        ...
        '#suffix' =>
          '</span> <span class="coupon-table-unit">' .
          $this->suffix .
          '</span>',
      ];
      ...
      if ($i != 1) {
        ...
        $form['coupon']['table']['row_' . $i]['delete'] = array(
          ...
          '#mask' => null,
          '#prefix' =>
            '<span class="coupon-table-delete" id="delete-' . $i . '">',
          '#suffix' => '</span>',
        );
      }
    }
    ...
    $form['coupon']['table']['total'] = [
      '#theme' => '',
      '#prefix' =>
        '<div id="coupon-table-total" class="coupon-table-total">
        ...
        '</span>
                ...
                <span class="coupon-table-total-unit">' .
        $this->suffix .
        '</span>
                </div>',
    ];
